...
namespace numcpp {
    ...
    public:
        ...
        RealType operator()(UniformRandomGenerator &urng) {
            return this->operator()(urng, this->m_param);
        }
