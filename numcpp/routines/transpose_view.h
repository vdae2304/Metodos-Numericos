 ...
 */
 ...
 /** @file include/numcpp/routines/transpose_view.h
...
namespace numcpp {
    ...
    /**
     * @brief A light-weight object which stores the elements of a tensor with
     * its axes reversed or permuted. Convertible to a tensor object.
     *
    ...
    public:
        ...
        /**
         * @brief Constructs a view which reverse or permute the axes of a
         * tensor.
         *
     ...
     * elements in a tensor with its axes reversed or permuted. Convertible to
     * a tensor object.
     *
     * @tparam T Type of the elements contained in the tensor.
     * @tparam Rank Dimension of the tensor. It must be a positive integer.
    ...
    public:
        ...
        typedef base_tensor_const_iterator<
            std::complex<T>, Rank, conj_transpose_tag<Tag>
        > iterator;
        typedef base_tensor_const_iterator<
            std::complex<T>, Rank, conj_transpose_tag<Tag>
        > const_iterator;
