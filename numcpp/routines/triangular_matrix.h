...
namespace numcpp {
    ...
    public:
         ...
         */
        base_matrix(
            const base_matrix<T, Tag> &mat, bool lower, ptrdiff_t offset = 0
        ...
        T operator()(size_t i, size_t j) const {
            ...
            if (this->m_offset >= 0) {
                if (i + this->m_offset == j) {
                    return this->m_mat(i, j);
                }
                else if (i + this->m_offset > j) {
                    return this->m_lower ? this->m_mat(i, j) : T(0);
                }
                else {
                    return this->m_lower ? T(0) : this->m_mat(i, j);
                }
            }
            else {
                if (i == j - this->m_offset) {
                    return this->m_mat(i, j);
                }
                else if (i > j - this->m_offset) {
                    return this->m_lower ? this->m_mat(i, j) : T(0);
                }
                else {
                    return this->m_lower ? T(0) : this->m_mat(i, j);
