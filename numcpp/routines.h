...
namespace numcpp {
    ...
    /** 
     * @brief Return the pair of indices of the maximum value in the matrix.
     * 
     * @param mat A matrix-like object.
     * @param i Reference to an index where the row location will be stored.
     * @param j Reference to an index where the column location will be stored.
     * 
    ...
    /** 
     * @brief Return the pair of indices of the minimum value in the matrix.
     * 
     * @param mat A matrix-like object.
     * @param i Reference to an index where the row location will be stored.
     * @param j Reference to an index where the column location will be stored.
    ...
    /** 
     * @brief Find the pairs of indices of the elements that evaluate to true.
     * 
     ...
     * variance; while ddof = 0 provides the maximum likelihood estimator 
    ...
    template <class T, class Tag>
    T percentile(
        const base_array<T, Tag> &arr, int q, 
        const std::string &method = "linear"
    );
    ...
    template <class T, class Tag>
    T percentile(
        const base_matrix<T, Tag> &mat, int q,
        const std::string &method = "linear"
    );
