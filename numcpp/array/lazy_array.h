...
namespace numcpp {
    ...
    public:
        ...
        R operator[](size_t i) const {
            return this->m_fun(this->m_arr[i]);
        }
    ...
    public:
        ...
        base_array(
            ...
            if (lhs.size() != rhs.size()) {
                ...
                sprintf(
                    ...
                    "shapes (%zu,) (%zu,)", lhs.size(), rhs.size()
                );
         ...
         */
        R operator[](size_t i) const {
            return this->m_fun(this->m_lhs[i], this->m_rhs[i]);
        }
    ...
    public:
        ...
        R operator[](size_t i) const {
            return this->m_fun(this->m_lhs[i], this->m_val);
        }
    ...
    public:
        ...
        R operator[](size_t i) const {
            return this->m_fun(this->m_val, this->m_rhs[i]);
        }
