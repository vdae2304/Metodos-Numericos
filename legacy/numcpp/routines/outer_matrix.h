...
namespace numcpp {
    ...
    public:
        ...
        /**
         * @brief Returns whether the outer_matrix is empty (i.e., whether its
         * size is 0).
         *
    ...
    protected:
        ...
        /// Reference to the first array argument.
        const base_array<T1, Tag1> &m_arr1;

        /// Reference to the second array argument.
    ...
    public:
        ...
        T operator()(size_t i, size_t j) const {
            ...
            size_t i1 = i / m_mat2.rows();
            size_t j1 = j / m_mat2.cols();
            size_t i2 = i % m_mat2.rows();
            size_t j2 = j % m_mat2.cols();
            return m_mat1(i1, j1) * m_mat2(i2, j2);
        }

        /**
         * @brief Subscript operator. Returns the element at a given row and
         * column in the kronecker_matrix.
         *
         * @param index An index_t object with the row and column position of
         *     an element in the kronecker_matrix.
         *
         * @return The element at the specified row and column in the
         *     kronecker_matrix.
         *
         ...
         */
        size_t rows() const {
            return m_mat1.rows() * m_mat2.rows();
        }
         ...
         */
        size_t cols() const {
            return m_mat1.cols() * m_mat2.cols();
        }
    ...
    protected:
        /// Reference to the first matrix argument.
        const base_matrix<T, Tag1> &m_mat1;

        /// Reference to the second matrix argument.
