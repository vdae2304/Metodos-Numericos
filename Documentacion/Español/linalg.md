...
en `tau`. La descomposición es calculada a través de transformaciones de 
Householder.
```cpp
template <class T>
void qr_raw(
...
y *D* es una matriz diagonal. Las columnas de *V* son conocidas como los 
vectores propios y los elementos en la diagonal de *D* son conocidos como los 
valores propios. La descomposición es calculada a través de rotaciones de 
Givens.
...
Calcula los valores propios de una matriz simétrica.
```cpp
template <class T>
