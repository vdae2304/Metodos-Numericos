...
RealType random(UniformRandomNumberGenerator &urng) {
  return std::generate_canonical<RealType,
                                 std::numeric_limits<RealType>::digits>(urng);
}
} // namespace detail
...
public:
   ...
   */
  void reset() { __gamma_rvs.reset(); }

  /**
   * @brief Returns the @f$\alpha@f$ of the distribution.
   */
  RealType alpha() const { return m_param.alpha(); }

  /**
   * @brief Returns the @f$\beta@f$ of the distribution.
   */
  RealType beta() const { return m_param.beta(); }
   ...
   */
  RealType min() const { return RealType(0); }

  /**
   * @brief Returns the least upper bound value of the distribution.
   */
  RealType max() const { return RealType(1); }
...
public:
  ...
  /**
   * @brief Constructs an inverse Gaussian distribution with parameters 1 and 1.
   */
   ...
   * @brief Resets the distribution state.
   */
  void reset() { __normal_rvs.reset(); }

  /**
   * @brief Returns the @f$\mu@f$ of the distribution.
   */
  RealType mu() const { return m_param.mu(); }

  /**
   * @brief Returns the @f$\lambda@f$ of the distribution.
   */
  RealType lambda() const { return m_param.lambda(); }
...
public:
  ...
  struct param_type {
    ...
    param_type(RealType mu, RealType s = RealType(1)) : m_mu(mu), m_s(s) {}
  ...
  /**
   * @brief Constructs a Laplace distribution with parameters @f$\mu@f$ and
   * @f$s@f$.
   */
   ...
   */
  RealType s() const { return m_param.s(); }
   ...
   * @brief Returns the greatest lower bound value of the distribution.
   */
  RealType min() const { return std::numeric_limits<RealType>::min(); }
...
public:
  ...
  /**
   * @brief Constructs a logistic distribution with parameters @f$\mu@f$ and
   * @f$s@f$.
   */
...
public:
  ...
  /**
   * @brief Constructs a Pareto distribution with parameters @f$\alpha@f$ and
   * @f$x_m@f$.
   */
   ...
   */
  RealType xm() const { return m_param.xm(); }
   ...
   * @brief Returns the greatest lower bound value of the distribution.
   */
  RealType min() const { return m_param.xm(); }
...
public:
  ...
  /**
   * @brief Constructs a Rayleigh distribution with parameter @f$\sigma@f$.
   */
   ...
   */
  RealType sigma() const { return m_param.sigma(); }
