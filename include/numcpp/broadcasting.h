 ...
 * @param a Abstract tensor to cast.
 *
 ...
 *         specified type.
 */
template <class U, class Expr, class T, size_t Rank>
unary_expr<cast_to<T, U>, Expr>
astype(const abstract_tensor<Expr, T, Rank> &a) {
  return unary_expr<cast_to<T, U>, Expr>(a);
}
 ...
 *                              broadcasting rules.
 */
template <class Expr1, class Expr2, class T, class U, size_t Rank>
void copyto(dense_tensor<Expr1, T, Rank> &dest,
            const abstract_tensor<Expr2, U, Rank> &src);

/**
 * @brief Return a copy of the tensor.
 *
 * @param a Abstract tensor to copy.
 * @param order Memory layout in which elements are stored. In row-major order,
 *              the last dimension is contiguous. In column-major order, the
...
tensor<T, Rank> copy(const abstract_tensor<Expr, T, Rank> &a);

template <class Expr, class T, size_t Rank>
tensor<T, Rank> copy(const abstract_tensor<Expr, T, Rank> &a, layout_t order);

/**
 * @brief Return a copy of the tensor flattened into one dimension.
 *
 * @param a Abstract tensor to flatten.
 ...
 */
template <class Expr, class T, size_t Rank>
tensor<T, 1> flatten(const abstract_tensor<Expr, T, Rank> &a);

template <class Expr, class T, size_t Rank>
tensor<T, 1> flatten(const abstract_tensor<Expr, T, Rank> &a, layout_t order);

/**
 * @brief Return a tensor of tuples with each element constructed from taking
 * the corresponding element from all tensors.
 *
 * @param a, b... Abstract tensors to zip. Since C++14, this function accepts
 ...
 */
template <class Expr1, class Expr2, class T, class U, size_t Rank>
binary_expr<detail::zip, Expr1, Expr2>
zip(const abstract_tensor<Expr1, T, Rank> &a,
    const abstract_tensor<Expr2, U, Rank> &b) {
  return binary_expr<detail::zip, Expr1, Expr2>(a, b);
}

#if __cplusplus >= 201402L
template <class Expr1, class... Expr2, class T, class... U, size_t Rank>
element_wise_expr<detail::zip, Expr1, Expr2...>
zip(const abstract_tensor<Expr1, T, Rank> &a,
    const abstract_tensor<Expr2, U, Rank> &...b) {
  return element_wise_expr<detail::zip, Expr1, Expr2...>(a, b...);
}
#endif // C++14
 ...
 * @param a An abstract tensor of tuple-like values. Any class overloading
 ...
 */
template <size_t I, class Expr, class Tuple, size_t Rank>
unary_expr<detail::unzip_by_index<I>, Expr>
unzip(const abstract_tensor<Expr, Tuple, Rank> &a) {
  return unary_expr<detail::unzip_by_index<I>, Expr>(a);
}

#if __cplusplus >= 201402L
template <class T, class Expr, class Tuple, size_t Rank>
unary_expr<detail::unzip_by_type<T>, Expr>
unzip(const abstract_tensor<Expr, Tuple, Rank> &a) {
  return unary_expr<detail::unzip_by_type<T>, Expr>(a);
}
#endif // C++14
 ...
 *              is 0.
 * @param a, b... Abstract tensors to concatenate. The tensors must have the
...
tensor<T, Rank> concatenate(const abstract_tensor<Expr1, T, Rank> &a,
                            const abstract_tensor<Expr2, T, Rank> &...b);

template <size_t Axis, class Expr1, class... Expr2, class T, size_t Rank>
tensor<T, Rank> concatenate(const abstract_tensor<Expr1, T, Rank> &a,
                            const abstract_tensor<Expr2, T, Rank> &...b);
 ...
 * @param a, b... Abstract tensors to stack. The tensors must have the same
 ...
 */
template <class Expr1, class... Expr2, class T, size_t Rank>
tensor<T, Rank + 1> stack(const abstract_tensor<Expr1, T, Rank> &a,
                          const abstract_tensor<Expr2, T, Rank> &...b);
 ...
 */
template <class Expr, class T, size_t Rank>
tensor<T, Rank> tile(const abstract_tensor<Expr, T, Rank> &a,
 ...
 */
template <class Expr, class T, size_t Rank>
tensor<T, Rank> repeat(const abstract_tensor<Expr, T, Rank> &a, size_t reps,
                       size_t axis = 0);

template <class Expr1, class Expr2, class T, class IntegralType, size_t Rank,
          detail::RequiresIntegral<IntegralType> = 0>
tensor<T, Rank> repeat(const abstract_tensor<Expr1, T, Rank> &a,
                       const abstract_tensor<Expr2, IntegralType, 1> &reps,
                       size_t axis = 0);
 ...
 */
template <class Expr, class T, size_t Rank>
tensor<T, Rank> pad(const abstract_tensor<Expr, T, Rank> &a,
 ...
 *                       an exception.
 */
template <class Expr, class T, size_t Rank, class Function, class... Args>
tensor<T, Rank> pad(const abstract_tensor<Expr, T, Rank> &a,
                    const shape_t<Rank> &before, const shape_t<Rank> &after,
 ...
 *
 * @param index An abstract tensor with the indices to flatten.
 ...
 */
template <class Expr, size_t Rank, size_t N>
unary_expr<detail::ravel_index<Rank>, Expr>
ravel_index(const abstract_tensor<Expr, index_t<Rank>, N> &index,
            const shape_t<Rank> &shape, layout_t order = default_layout) {
  return unary_expr<detail::ravel_index<Rank>, Expr>(
 ...
 *
 * @param index An abstract tensor with the indices to unravel.
 ...
 *         not create a new tensor, instead, an expression object is returned.
 */
template <class Expr, class IntegralType, size_t Rank, size_t N,
          detail::RequiresIntegral<IntegralType> = 0>
unary_expr<detail::unravel_index<Rank>, Expr>
unravel_index(const abstract_tensor<Expr, IntegralType, N> &index,
              const shape_t<Rank> &shape, layout_t order = default_layout) {
  return unary_expr<detail::unravel_index<Rank>, Expr>(
 ...
 * @param indices An abstract tensor of @c index_t with the indices of the
 *                values to take. If the source tensor is 1-dimensional, an
 *                abstract tensor of integers can be used instead.
 *
 ...
 *                       an exception.
 */
template <class Expr1, class Expr2, class T, size_t Rank, size_t N>
tensor<T, N> take(const abstract_tensor<Expr1, T, Rank> &a,
                  const abstract_tensor<Expr2, index_t<Rank>, N> &indices);

template <class Expr1, class Expr2, class T, class IntegralType, size_t N,
          detail::RequiresIntegral<IntegralType> = 0>
tensor<T, N> take(const abstract_tensor<Expr1, T, 1> &a,
                  const abstract_tensor<Expr2, IntegralType, N> &indices);

/**
 * @brief Take elements from a tensor along an axis.
 *
 * @param a The source tensor.
 * @param indices An abstract tensor with the indices of the values to take.
...
template <class Expr1, class Expr2, class T, class IntegralType, size_t Rank,
          detail::RequiresIntegral<IntegralType> = 0>
tensor<T, Rank> take(const abstract_tensor<Expr1, T, Rank> &a,
                     const abstract_tensor<Expr2, IntegralType, 1> &indices,
                     size_t axis);

template <class Expr, class T, size_t Rank>
tensor<T, Rank - 1> take(const abstract_tensor<Expr, T, Rank> &a, size_t index,
                         size_t axis);
 ...
 *
 * @param a The source tensor.
 * @param indices An abstract tensor with the indices to take along each 1d
...
template <class Expr1, class Expr2, class T, class IntegralType, size_t Rank,
          detail::RequiresIntegral<IntegralType> = 0>
tensor<T, Rank>
take_along_axis(const abstract_tensor<Expr1, T, Rank> &a,
                const abstract_tensor<Expr2, IntegralType, Rank> &indices,
                size_t axis);
 ...
 * @param indices An abstract tensor of @c index_t with the target indices. If
 *                the source tensor is 1-dimensional, an abstract tensor of
 *                integers can be used instead.
 * @param values A single value or an abstract tensor with the values to put
 ...
 */
template <class Expr1, class Expr2, class Expr3, class T, size_t Rank, size_t N>
void put(dense_tensor<Expr1, T, Rank> &a,
         const abstract_tensor<Expr2, index_t<Rank>, N> &indices,
         const abstract_tensor<Expr3, T, N> &values);

template <class Expr1, class Expr2, class T, size_t Rank, size_t N>
void put(dense_tensor<Expr1, T, Rank> &a,
         const abstract_tensor<Expr2, index_t<Rank>, N> &indices,
         const typename detail::identity<T>::type &value);

template <class Expr1, class Expr2, class Expr3, class T, class IntegralType,
          size_t N, detail::RequiresIntegral<IntegralType> = 0>
void put(dense_tensor<Expr1, T, 1> &a,
         const abstract_tensor<Expr2, IntegralType, N> &indices,
         const abstract_tensor<Expr3, T, N> &values);
 ...
 * @param indices An abstract tensor with the indices to change along each 1d
 *                slice of @a a. This must match the shape of @a a for all
 *                dimensions other than @a axis.
 * @param values An abstract tensor with the values to insert at those indices.
 *               Its shape is broadcast to match the shape of @a indices.
 * @param axis The axis to take 1d slices along.
 *
 * @throw std::invalid_argument Thrown if the shape of @a values is not
 *                              compatible with the shape of @a indices
 ...
 */
template <class Expr1, class Expr2, class Expr3, class T, class IntegralType,
          size_t Rank, detail::RequiresIntegral<IntegralType> = 0>
void put_along_axis(dense_tensor<Expr1, T, Rank> &a,
                    const abstract_tensor<Expr2, IntegralType, Rank> &indices,
                    const abstract_tensor<Expr3, T, Rank> &values, size_t axis);
 ...
 *
 * @param a The input tensor.
 * @param condition An abstract tensor of @c bool whose true entries indicate
 ...
 */
template <class Expr1, class Expr2, class T, size_t Rank>
tensor<T, 1> compress(const abstract_tensor<Expr1, T, Rank> &a,
                      const abstract_tensor<Expr2, bool, Rank> &condition);
 ...
 */
template <class Expr1, class Expr2, class T, size_t Rank>
tensor<T, Rank> compress(const abstract_tensor<Expr1, T, Rank> &a,
                         const abstract_tensor<Expr2, bool, 1> &condition,
                         size_t axis);
 ...
 * @param values A single value or an abstract tensor with the values to place
 ...
 *                              match the shape of @a a.
 */
template <class Expr1, class Expr2, class Expr3, class T, size_t Rank>
void place(dense_tensor<Expr1, T, Rank> &a,
           const abstract_tensor<Expr2, bool, Rank> &condition,
           const abstract_tensor<Expr3, T, 1> &values);

template <class Expr1, class Expr2, class T, size_t Rank>
void place(dense_tensor<Expr1, T, Rank> &a,
           const abstract_tensor<Expr1, bool, Rank> &condition,
           const typename detail::identity<T>::type &value);
 ...
 * @param a Tensor to put data into.
 * @param condition Boolean mask tensor.
 * @param values An abstract tensor with the values to put into @a a where
 ...
 */
template <class Expr1, class Expr2, class Expr3, class T, size_t Rank>
void putmask(dense_tensor<Expr1, T, Rank> &a,
             const abstract_tensor<Expr2, bool, Rank> &condition,
             const abstract_tensor<Expr3, T, Rank> &values);
} // namespace numcpp
